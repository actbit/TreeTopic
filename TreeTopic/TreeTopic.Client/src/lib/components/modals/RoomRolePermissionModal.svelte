...
<Modal {isOpen} title="Room Role Permission Management" onClose={handleClose} size="xlarge" closeButton={!isLoading}>
      ...
      {:else}
        ...
        {#if showCreateRole}
          <div class="border border-border rounded-lg p-4 bg-surface">
            ...
            <div class="space-y-3">
              <div>
                <label for="role-name-input" class="block text-sm font-medium text-text mb-1">Role Name</label>
                <input
                  id="role-name-input"
                  type="text"
                  bind:value={newRoleName}
                  placeholder="e.g. Members, Moderators"
                  class="w-full px-3 py-2 border border-border rounded focus:outline-none focus:border-primary"
                />
              </div>
              <div>
                <label for="role-desc-input" class="block text-sm font-medium text-text mb-1">Description</label>
                <input
                  id="role-desc-input"
                  type="text"
          ...
          <div class="space-y-4">
            {#each roles as role}
              ...
              <div class="border border-border rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                  <h4 class="text-sm font-medium text-text mb-3">Permissions</h4>
